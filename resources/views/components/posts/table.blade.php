...
<section class="p-3 sm:p-5 antialiased">
    <h2 class="text-2xl font-semibold p-3">Post by: {{ Auth::user()->name }}</h2>
                    ...
                    <form class="flex items-center">
                        ...
                        <div class="relative w-full">
                            ...
                            <input type="text" id="simple-search" name="keyword"
                                ...
                                placeholder="Search Post" value="{{ old('keyword', request('keyword')) }}">
                        </div>
                    </form>
                </div>
                <div
                    ...
                    <tbody>
                        @foreach ($posts as $post)
                            <tr class="border-b dark:border-gray-700">
                                ...
                                <td class="px-4 py-3">{{ $post->created_at->format('d F Y') }}</td>
